...
const NavBar = () => {
  ...
  const profileMenu = [text.profilemenu.profile, text.profilemenu.orders, text.profilemenu.logout];
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 px-10 ${
        scrolled
